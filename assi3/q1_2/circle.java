...
public class circle extends Applet implements MouseWheelListener{
    ...
    public void level1(){
        ...
        // arr.add(c);
        Circle c = new Circle(0,0, (int)(r+x));
        bigc = c;
    ...
    public void randlevel(){
        ...
        while(i<400)
        {
            ...
            // int x1 = (int)(Math.random()*wid)-wid/2;
            // int y1 = (int)(Math.random()*hei)-hei/2;
    ...
    public void paint(Graphics g){
        ...
        {
            Circle c = arr.get(i);
            // System.out.println("Circle "+i+" radius = "+c.r+" center("+c.cx+","+c.cy+")");
            makeCircle(g,c);
        }
        delay(1000);
        arr.clear();
        ...
        // System.out.println("window height ="+hei);
        // System.out.println("window width ="+wid);        
    }
}
